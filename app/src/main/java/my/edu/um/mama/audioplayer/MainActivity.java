...
public class MainActivity extends AppCompatActivity {
    ...
    public static final int[] MEDIA_RES_ID_LIST = new int[]{R.raw.song,R.raw.nextsong,R.raw.nextsongtwo,R.raw.nextsong3,R.raw.nextsong4};
    ...
    protected void onStart(){
        super.onStart();
        mPlayerAdapter.setMediaList(MEDIA_RES_ID_LIST);
    ...
    public class PlaybackListener extends PlaybackInfoListener {
        ...
        public void onPositionChanged(int position){
            if(!mUserIsSeeking){
                ...
                Log.d(TAG, String.format("stePlaybackPosition: setProgress(%d)", position));
            }
        }
        ...
        public void onLogUpdated(String message){
            if(mTextDebug != null){
                ...
                mTextDebug.append("\n");
                //Moves teh scrollContainer focus to the end.
